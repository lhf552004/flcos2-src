...
/* harmony import */ var _route_resolvers_user_resolver_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./route-resolvers/user-resolver.service */ "./src/app/profile/route-resolvers/user-resolver.service.ts");
...
const routes = [{ path: '', component: _profile_profile_component__WEBPACK_IMPORTED_MODULE_2__["ProfileComponent"], resolve: { user: _route_resolvers_user_resolver_service__WEBPACK_IMPORTED_MODULE_3__["UserResolverService"] } }];
...
/* harmony import */ var _profile_profile_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile/profile.component */ "./src/app/profile/profile/profile.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ProfileModule, { declarations: [_profile_profile_component__WEBPACK_IMPORTED_MODULE_1__["ProfileComponent"]], imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"],
        _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"],
        _angular_material_input__WEBPACK_IMPORTED_MODULE_4__["MatInputModule"],
        _angular_material_module__WEBPACK_IMPORTED_MODULE_3__["AngularMaterialModule"],
        _profile_routing_module__WEBPACK_IMPORTED_MODULE_2__["ProfileRoutingModule"]] }); })();
...
/* harmony import */ var _core_user_authentication_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../core/user/authentication.service */ "./src/app/core/user/authentication.service.ts");
/* harmony import */ var _core_notificator_notificator_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../core/notificator/notificator.service */ "./src/app/core/notificator/notificator.service.ts");
...
function ProfileComponent_mat_error_49_Template(rf, ctx) { if (rf & 1) {
...
class ProfileComponent {
    constructor(route, router, userService, authenticationService, formBuilder, notificatorService) {
        this.route = route;
        this.router = router;
    ...
    ngOnInit() {
        ...
        this.authenticationService.currentUser.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.unsubscribe)).subscribe(user => {
            if (user == null) {
    ...
    save() {
        ...
        this.userService.updateUser(this.currentUser.id, this.currentUser, true).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.unsubscribe)).subscribe(x => {
            this.notificatorService.sendNotification(new _core_notificator_notification_model__WEBPACK_IMPORTED_MODULE_4__["Notification"]('Update profile successfully!', 'info'));
        });
    }
    cancel() {
        this.router.navigate(['/']);
    ...
    changePassword() {
        this.userService.updateUser(this.currentUser.id, this.currentUser, false).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.unsubscribe)).subscribe(x => {
            this.notificatorService.sendNotification(new _core_notificator_notification_model__WEBPACK_IMPORTED_MODULE_4__["Notification"]('Change password successfully!', 'info'));
        });
    }
    infoChanged() {
...
ProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProfileComponent, selectors: [["emes-profile"]], decls: 62, vars: 22, consts: [[1, "container-fluid", "d-flex", "flex-column"], [1, "container"], [1, "card-deck"], [1, "card"], [1, "card-body"], [1, "card-text"], ["hintLabel", "Max 10 characters", "appearance", "fill"], ["matInput", "", "maxlength", "10", "placeholder", "Ex. Nougat", 3, "ngModel", "ngModelChange", "input"], ["lastName", ""], ["align", "end"], ["firstName", ""], ["mat-button", "", "color", "primary", 3, "disabled", "click"], ["mat-button", "", "color", "primary", 3, "click"], [3, "formGroup"], ["matInput", "", "type", "password", "placeholder", "Password", "formControlName", "password", 3, "ngModel", "type", "ngModelChange", "input"], ["mat-icon-button", "", "matSuffix", "", 3, "click"], [4, "ngIf"], ["matInput", "", "type", "password", "placeholder", "Confirm password", "formControlName", "password2", 3, "type", "input"]], template: function ProfileComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ProfileComponent_Template_input_ngModelChange_14_listener($event) { return ctx.currentUser.lastName = $event; })("input", function ProfileComponent_Template_input_input_14_listener() { return ctx.infoChanged(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ProfileComponent_Template_input_ngModelChange_21_listener($event) { return ctx.currentUser.firstName = $event; })("input", function ProfileComponent_Template_input_input_21_listener() { return ctx.infoChanged(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ProfileComponent_Template_input_ngModelChange_28_listener($event) { return ctx.currentUser.email = $event; })("input", function ProfileComponent_Template_input_input_28_listener() { return ctx.infoChanged(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileComponent_Template_button_click_32_listener() { return ctx.save(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileComponent_Template_button_click_34_listener() { return ctx.cancel(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ProfileComponent_Template_input_ngModelChange_45_listener($event) { return ctx.currentUser.password = $event; })("input", function ProfileComponent_Template_input_input_45_listener() { return ctx.onPasswordInput(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](46, "button", 15);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileComponent_Template_button_click_46_listener() { return ctx.hide = !ctx.hide; });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function ProfileComponent_Template_input_input_52_listener() { return ctx.onPasswordInput(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](53, "button", 15);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileComponent_Template_button_click_53_listener() { return ctx.hide = !ctx.hide; });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileComponent_Template_button_click_58_listener() { return ctx.changePassword(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileComponent_Template_button_click_60_listener() { return ctx.cancel(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProfileComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }, { type: _core_user_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"] }, { type: _core_user_authentication_service__WEBPACK_IMPORTED_MODULE_7__["AuthenticationService"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _core_notificator_notificator_service__WEBPACK_IMPORTED_MODULE_8__["NotificatorService"] }]; }, null); })();
...
/* harmony import */ var _core_user_authentication_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../core/user/authentication.service */ "./src/app/core/user/authentication.service.ts");
...
class UserResolverService {
    constructor(userService, authenticationService, router) {
        this.userService = userService;
        this.authenticationService = authenticationService;
        this.router = router;
    }
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserResolverService, [{
    ...
    }], function () { return [{ type: _core_user_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"] }, { type: _core_user_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }]; }, null); })();
