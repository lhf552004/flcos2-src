...
class BinService {
    ...
    getBinsByIds(ids) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(this.bins.filter(b => ids.includes(b.id)));
    }
    getBin(id) {
...
class UserService {
    ...
    getUser(id) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(this.users.find(x => x.id === id));
    }
    getUsers() {
    ...
    createUser(newUser) {
        ...
        //   }));
        const users = this.users$.getValue();
        users.push(Object.assign(Object.assign({}, newUser), { id: '123', roles: [], enabled: true }));
        this.users$.next(users);
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(this.users);
    }
    updateUser(id, updatedUser, updateNeeded) {
        // const url = `${this.userUrl}/${id}`;
...
class EquipmentService {
    ...
    getEquipmentsByIds(ids) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(this.equipments.filter(eq => ids.includes(eq.id)));
    }
    getEquipment(id) {
    ...
    getSectionsByIds(ids) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(this.sections.filter(s => ids.includes(s.id)));
    }
    getSection(id) {
...
class SchemeService {
    ...
    getSchemeNames() {
        ...
        // }));
        const schemeName = [this.mockedOrderScheme.schemeName];
...
SchemeService.ɵfac = function SchemeService_Factory(t) { return new (t || SchemeService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"])); };
SchemeService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: SchemeService, factory: SchemeService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SchemeService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkflowSettings", function() { return WorkflowSettings; });
